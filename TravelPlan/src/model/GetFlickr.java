...
public class GetFlickr {
	 ...
	 */
		...
		public static ArrayList<PhotoBean> getPhotos(String keyword, int count) throws MalformedURLException, IOException, XMLStreamException{
			...
			URLConnection uc = new URL(
					"http://api.flickr.com/services/rest/?method=" + method
							...
							+ "&text=" + URLEncoder.encode(keyword) + "&tag_mode=all&content_type=1&sort=relevance").openConnection();
			BufferedReader br = new BufferedReader(new InputStreamReader(uc.getInputStream()));
			BufferedWriter bw = new BufferedWriter(new FileWriter(new File("test.xml")));
			String nextline;
